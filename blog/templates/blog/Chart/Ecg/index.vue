...
export default {
    props: {
        ...
        lineNum: { type: Number, default: 12 }, // 数据队列数量, 最小为1，超出边界被边界覆盖（导联数量）
        index: { type: Number, default: 0 }, // 从第几条队列开始展示 [0, lineNum - 1]
        lineWidth: { type: Number, default: 3 },
        padding: { type: Array, default: () => [30] },
        bg: {
            type: [Object, String],
            default: () => {
                return {
        ...
        const methods = {
            ...
            setMock() {
                ...
                data.timer = setInterval(() => {
                    ...
                    const value = props.ySide[0] + Math.random() * (props.ySide[1] - props.ySide[0])
                    data.canvas.setData(index, value)
